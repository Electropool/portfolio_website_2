...
const DelicateAsciiDots = ({
  backgroundColor = 'transparent', // Modified to transparent to lay over the existing background
  textColor = '124, 58, 237',      // Modified to purple to match the portfolio theme
  gridSize = 80,
  removeWaveLine = true,
  animationSpeed = 0.75,
  ...
  return (
    <div
      ...
      style={{ backgroundColor: backgroundColor !== 'transparent' ? backgroundColor : undefined, zIndex: 1 }}
    >
